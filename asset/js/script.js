...
//         // Function to initialize the carousel with dynamic cards
//         data.forEach(game => {
...
//         timeoutId = setTimeout(() => carousel.scrollLeft += carousel.offsetWidth, 3500);
//     };
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const initializeCardSlider = (data) => {
        ...
        data.forEach(game => {
            ...
            // Add click event to set iframe src when card is clicked
